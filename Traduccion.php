    ...
    if($_POST["lengua"] == "1")
    {
        for($i=0; $i < count($separadoM); $i++)
        {
            for($j=0; $j < count($morse); $j++)
            {
                ...
                {
                    echo "Ha escrito de forma incorrecta su texto, favor de escribirlo correctamente";
                    $s=1;
                }
            }
        }
        if($s!=1){
            echo "su texto a traducir es:     ", "$texE";
            echo "<br><br>";
    ...
    elseif($_POST["lengua"] == "0")
    {
        for($i=0; $i < count($separadoM); $i++)
        {
            for($j=0; $j < count($morse); $j++)
            {
                ...
                {
                    echo "Ha escrito de forma incorrecta su texto en morse, favor de escribirlo correctamente";
                    $h=1;
                }
            }
        }

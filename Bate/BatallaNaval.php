...
<body>
    ...
    <?php
       ...
       if(isset($_POST["Cordenadas"]))
        ...
        foreach($bar1 as $llaver => $valor){
            if($valor != $ataque)
                $c++;
        }
        foreach($bar2 as $llaver => $valor){
            if($valor != $ataque)
                $d++;
        }
        ...
        for($vidas=$e; $vidas>0; $vidas--)
            echo '<img src="./corazon.png" width="15" height="15" alt="corazon">';
            ...
            for($i=0; $i < $filas; $i++)
            {
                ...
                for($j=0; $j < $celdas; $j++)
                {
                    echo "<td>";
                            ...
                            if($a==1 && $ataque == $casillas[$i][$j] /*|| $b==1*/){
    ...
    <?php
    //echo "<input type="hidden" name='Cordenadas[]' value='$historial'>";
